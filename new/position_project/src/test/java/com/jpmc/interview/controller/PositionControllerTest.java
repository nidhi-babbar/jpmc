...
public class PositionControllerTest {
    ...
    public void testPositionValue() {
        ...
        when(positionService.getPositionsByAccountIds(accountIds)).thenReturn(expectedResult);
        List<Account> result = positionController.getPositionsByAccountIds(accountIds);
